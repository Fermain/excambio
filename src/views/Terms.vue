<template>
  <div class="page">
    ...
    <p>Version 1.0</p>
    <p>
      The Example website located at example.com is a copyrighted work belonging
      to Example. Certain features of the Site may be subject to additional
    ...
    <p>
      ...
      should be sent to: Example. After the Notice is received, you and the
